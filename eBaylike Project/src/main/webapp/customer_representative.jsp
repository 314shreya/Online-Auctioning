...
<div class="nav_bar">
  ...
  <a class="is_act" href="customer_representative.jsp" id="customer_representative" style="display: none">Customer Representative</a>
...
<div>
	...
	<table>
	    ...
	    try {
			...
			String sql = "SELECT name as name, email as email from users where is_admin not in (1,2)";
			PreparedStatement pst1 = con.prepareStatement(sql);
			ResultSet rs = pst1.executeQuery();
			while (rs.next())
			{
				out.println("<tr><td>"+rs.getString("name")+"</td>"+"<td>"+rs.getString("email")+"</td>"+"</td><td><form method = \"post\" action=\"CustomerRepresentativeServlet\"><input type=\"hidden\" name= \"uemail\" value="+rs.getString("email")+"><button type=\"submit\" style=\"width: 100%\">Customer Representative</button></form></td></tr>");
			}
	    }
	    catch (Exception e)
	    {
